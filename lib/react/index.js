...
// Hooks are loaded lazily since they use ES modules and require React
let hooks = null;
function getHooks() {
  if (!hooks) {
    try {
      ...
      // Hooks not available (React not installed or ESM not supported)
      hooks = {};
    }
  }
  return hooks;
