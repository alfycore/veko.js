...
class RouteManager {
  ...
  // Méthode pour arrêter le nettoyage du cache
  stopCacheCleanup() {
  ...
  // La méthode createRoute principale est définie dans le bloc 170-240
  // Suppression de la duplication - cette version utilise l'implémentation avancée ci-dessus
