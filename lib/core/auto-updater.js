...
╚═══════════════════════════════════════════════════════════╝
    ...
    // 🌐 Récupération des informations de version avec gestion d'erreur améliorée
    static async getVersionInfo() {
        return new Promise((resolve, reject) => {
            try {
                ...
                reject(new Error(`Erreur de configuration de la requête: ${error.message}`));
            }
        });
    }
    ...
    // 🎯 Fonction d'entrée interactive améliorée avec détection d'environnement non-interactif
